...
$passengers = $conn_prit->query("SELECT * FROM Клиенты");
...
<body>
    <h2>Клиенты ООО "Цифровые системы"</h2>
    <table>
        <thead>
            <tr>
            <th>ID</th>
                ...
                <th>Цена сделки</th>
                <th>Дата с момента обращения</th>
                <th>Выявлено специалистом:</th>
            </tr>
        </thead>
        <tbody>
            <?php while ($row = $passengers->fetch_assoc()): ?>
                ...
                <td><?php echo $row['ID']; ?></td>
                    ...
                    <td><?php echo $row['Цена вопроса']; ?></td>
                    <td><?php echo $row['Дата_обращения']; ?></td>
                    <td><?php echo $row['Причина']; ?></td>
